...
class WebSocketManager {
    constructor() {
        ...
        this.RECONNECT_DELAY = 3000; // 3秒，会随重连次数指数增加
    ...
    sendMessage(message) {
        ...
        try {
            const messageStr = JSON.stringify({
                ...message,
				content: typeof message.content === 'object' ? JSON.stringify(message.content) : message.content, // 确保 content 是字符串
